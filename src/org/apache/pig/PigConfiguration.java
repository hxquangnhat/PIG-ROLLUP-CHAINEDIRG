...
public class PigConfiguration {
     ...
     * through the RollupH2IRGOptimizer
     */
    public static final String PIG_H2IRG_ROLLUP_OPTIMIZABLE = "pig.h2irg.rollup.optimizable";
     ...
     */
    public static final String PIG_H2IRG_ROLLUP_PIVOT = "pig.h2irg.rollup.pivot";
     ...
     */
    public static final String PIG_H2IRG_ROLLUP_FIELD_INDEX = "pig.h2irg.rollup.field.index";
     ...
     */
    public static final String PIG_H2IRG_ROLLUP_OLD_FIELD_INDEX = "pig.h2irg.rollup.old.field.index";
    
    /**
     * This parameter stores the size of total fields which involve in the rollup
     */
    public static final String PIG_H2IRG_ROLLUP_TOTAL_FIELD = "pig.h2irg.rollup.total.field";
    
    public static final String PIG_H2IRG_ROLLUP_CHUNKSIZE = "pig.h2irg.rollup.chunksize";
    
    public static final String PIG_H2IRG_ROLLUP_RATE = "pig.h2irg.rollup.rate";
    
    public static final String PIG_H2IRG_ROLLUP_VARIABLESPLIT = "pig.h2irg.rollup.variablesplit";
    
    public static final String PIG_H2IRG_ROLLUP_IRG2 = "pig.h2irg.rollup.irg2";
}
