...
public class POLocalRearrange extends PhysicalOperator {
    ...
    public static long preLRTime = 0;
    
    public static long localRearrangeTime = 0;
    ...
    public Result getNextTuple() throws ExecException {
        ...
        while (true) {
            ...
            for (ExpressionOperator op : leafOps){
                ...
                case DataType.MAP:
                case DataType.TUPLE:
                    preLRTime = System.currentTimeMillis();
                    res = op.getNext(op.getResultType());
                    localRearrangeTime += System.currentTimeMillis() - preLRTime;
                    break;
                default:
