...
public class PigRollupSampleCombiner {
    ...
    public static class Combine
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
            ...
            roots = null;
            cp = null;
            log.debug("Combiner cleanup");
            long cleanupTime = System.currentTimeMillis();
            System.out.println("COMBINER");
            System.out.println("t7 Combine setup-cleanup: " + setupTime + " " + cleanupTime + " Total: " + (cleanupTime - setupTime));
            System.out.println("t7 Combine write time: " + combineWTime);
            ...
            long tTotal = cleanupTime - setupTime;
            counter.append(tTotal);
            counter.append(setupTime);
            counter.append(cleanupTime);
            counter.append(combineWTime);
            //Tuple holds value
