...
**/
public abstract class PigGenericMapBaseRollupSample extends Mapper<Text, Tuple, PigNullableWritable, Writable> {
    ...
    static public long sTime = 0;
    static public long fTime = 0;
    ...
    static public long mapWriteTime = 0;
    
    long tPreCollect = 0;
    
    static public long tCollect = 0;
    
    public static long mapWrite[] = new long[7];
    ...
    protected void runPipeline(PhysicalOperator leaf) throws IOException, InterruptedException {
        while(true){
            ...
            if(res.returnStatus==POStatus.STATUS_OK){
                ...
                mapWriteTime += System.currentTimeMillis() - swTime;
                continue;
            }
