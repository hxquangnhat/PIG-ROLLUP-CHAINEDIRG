    ...
    public void visitMROp(MapReduceOper mr) throws VisitorException {
        ...
        if (successor instanceof POForEach) {
            ...
            try {
                ...
                POPackage newReducePack = null;
                
                //if this job is the sampling job for rollup, we use the 
                //PORollupCombinerPackage instead of POCombinerPackage
                /*if(mr.isRollupSampler()) {
                    newReducePack = new PORollupCombinerPackage(pack, bags);
                    newReducePack.setChunkSize(pack.getChunkSize());
                    newReducePack.setRate(pack.getRate());
                }
                else*/
                    newReducePack = new POCombinerPackage(pack, bags);
