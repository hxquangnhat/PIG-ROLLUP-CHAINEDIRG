...
public class MapReduceOper extends Operator<MROpPlanVisitor> {
    ...
    private static enum OPER_FEATURE {
        ...
        HASHJOIN,
        // Indicate if this job is a rollup irg1 job
        ROLLUP1,
        // Indicate if this job is a rollup irg2 job
        ROLLUP2,
        // Indicate if this job is a sampling of a rollup job
        ROLLUP_SAMPLER;
    };
    ...
    public boolean isRollupSampler() {
        return (feature == OPER_FEATURE.ROLLUP_SAMPLER);
    }
    
    public void markRollupSampler() {
        feature = OPER_FEATURE.ROLLUP_SAMPLER;
    }
    
    public boolean isRollup1() {
        return (feature == OPER_FEATURE.ROLLUP1);
    }
    
    public void markRollup1() {
        feature = OPER_FEATURE.ROLLUP1;
    }
    
    public boolean isRollup2() {
        return (feature == OPER_FEATURE.ROLLUP2);
    }
    
    public void markRollup2() {
        feature = OPER_FEATURE.ROLLUP2;
    }
